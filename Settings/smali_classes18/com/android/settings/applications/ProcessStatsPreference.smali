...
.method public init(Lcom/android/settings/applications/ProcStatsPackageEntry;Landroid/content/pm/PackageManager;DDDZ)V
    ...
    :goto_0
    invoke-virtual {p0, v2}, Lcom/android/settings/applications/ProcessStatsPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    :cond_4
    iget-wide v5, v1, Lcom/android/settings/applications/ProcStatsPackageEntry;->mBgWeight:D
    ...
    iget-wide v5, v1, Lcom/android/settings/applications/ProcStatsPackageEntry;->mMaxRunMem:J

    goto :goto_4

    :cond_6
    iget-wide v5, v1, Lcom/android/settings/applications/ProcStatsPackageEntry;->mMaxBgMem:J
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/applications/ProcessStatsPreference;->setSummary(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/settings/applications/ProcessStatsPreference;->setProgress(I)V
