...
.method private update(Landroid/content/Context;Landroid/app/ActivityManager;)Z
    ...
    iget-wide v4, v11, Landroid/app/ActivityManager$RunningServiceInfo;->restarting:J

    cmp-long v4, v4, v12

    if-nez v4, :cond_b

    iget v4, v11, Landroid/app/ActivityManager$RunningServiceInfo;->pid:I

    if-lez v4, :cond_b

    iget-object v4, v1, Lcom/android/settings/applications/RunningState;->mTmpAppProcesses:Landroid/util/SparseArray;

    iget v5, v11, Landroid/app/ActivityManager$RunningServiceInfo;->pid:I
    ...
    iget-boolean v5, v4, Lcom/android/settings/applications/RunningState$AppProcessInfo;->hasForegroundServices:Z

    if-nez v5, :cond_b

    iget-object v5, v4, Lcom/android/settings/applications/RunningState$AppProcessInfo;->info:Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    iget-boolean v14, v4, Lcom/android/settings/applications/RunningState$AppProcessInfo;->hasServices:Z

    if-nez v14, :cond_9

    iget-object v14, v4, Lcom/android/settings/applications/RunningState$AppProcessInfo;->info:Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    iget v5, v11, Landroid/app/ActivityManager$RunningServiceInfo;->uid:I
    ...
    iget v14, v11, Landroid/app/ActivityManager$RunningServiceInfo;->uid:I

    invoke-virtual {v5, v14, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    :cond_c
    iget-object v5, v11, Landroid/app/ActivityManager$RunningServiceInfo;->process:Ljava/lang/String;
    ...
    iget v15, v11, Landroid/app/ActivityManager$RunningServiceInfo;->uid:I

    iget-object v12, v11, Landroid/app/ActivityManager$RunningServiceInfo;->process:Ljava/lang/String;
    ...
    :cond_d
    iget v12, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mCurSeq:I
    ...
    iget v12, v11, Landroid/app/ActivityManager$RunningServiceInfo;->pid:I
    ...
    :goto_9
    iget v13, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I
    ...
    :cond_10
    iput v12, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I

    :cond_11
    iget-object v13, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mDependentProcesses:Landroid/util/SparseArray;

    invoke-virtual {v13}, Landroid/util/SparseArray;->clear()V

    iget v13, v1, Lcom/android/settings/applications/RunningState;->mSequence:I

    iput v13, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mCurSeq:I

    :cond_12
    invoke-virtual {v5, v2, v11}, Lcom/android/settings/applications/RunningState$ProcessItem;->updateService(Landroid/content/Context;Landroid/app/ActivityManager$RunningServiceInfo;)Z
    ...
    new-instance v11, Lcom/android/settings/applications/RunningState$ProcessItem;
    ...
    invoke-direct {v11, v2, v12, v13}, Lcom/android/settings/applications/RunningState$ProcessItem;-><init>(Landroid/content/Context;ILjava/lang/String;)V

    move-object v7, v11

    iget v11, v5, Landroid/app/ActivityManager$RunningAppProcessInfo;->pid:I

    iput v11, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I
    ...
    :cond_14
    iget-object v11, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mDependentProcesses:Landroid/util/SparseArray;

    invoke-virtual {v11}, Landroid/util/SparseArray;->clear()V

    :cond_15
    invoke-direct {v1, v5}, Lcom/android/settings/applications/RunningState;->isInterestingProcess(Landroid/app/ActivityManager$RunningAppProcessInfo;)Z

    move-result v11

    if-eqz v11, :cond_17

    iget-object v11, v1, Lcom/android/settings/applications/RunningState;->mInterestingProcesses:Ljava/util/ArrayList;
    ...
    :cond_16
    iget v11, v1, Lcom/android/settings/applications/RunningState;->mSequence:I

    iput v11, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mCurSeq:I

    const/4 v11, 0x1

    iput-boolean v11, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mInteresting:Z

    invoke-virtual {v7, v3}, Lcom/android/settings/applications/RunningState$ProcessItem;->ensureLabel(Landroid/content/pm/PackageManager;)V
    ...
    iput v11, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mRunningSeq:I
    ...
    :cond_18
    iget-object v4, v1, Lcom/android/settings/applications/RunningState;->mRunningProcesses:Landroid/util/SparseArray;
    ...
    iget v11, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mRunningSeq:I

    iget v12, v1, Lcom/android/settings/applications/RunningState;->mSequence:I

    if-ne v11, v12, :cond_1c

    iget-object v11, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mRunningProcessInfo:Landroid/app/ActivityManager$RunningAppProcessInfo;

    iget v11, v11, Landroid/app/ActivityManager$RunningAppProcessInfo;->importanceReasonPid:I

    if-eqz v11, :cond_1b

    iget-object v12, v1, Lcom/android/settings/applications/RunningState;->mServiceProcessesByPid:Landroid/util/SparseArray;
    ...
    iget v14, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I

    invoke-virtual {v13, v14, v7}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V
    ...
    iput-object v12, v7, Lcom/android/settings/applications/RunningState$ProcessItem;->mClient:Lcom/android/settings/applications/RunningState$ProcessItem;
    ...
    iget-boolean v12, v11, Lcom/android/settings/applications/RunningState$ProcessItem;->mInteresting:Z
    ...
    invoke-virtual {v12, v2, v3, v14}, Lcom/android/settings/applications/RunningState$ProcessItem;->buildDependencyChain(Landroid/content/Context;Landroid/content/pm/PackageManager;I)Z
    ...
    :goto_12
    iget-object v0, v1, Lcom/android/settings/applications/RunningState;->mServiceProcessesByName:Landroid/util/SparseArray;
    ...
    iget v4, v15, Lcom/android/settings/applications/RunningState$ProcessItem;->mCurSeq:I

    move/from16 v20, v5

    iget v5, v1, Lcom/android/settings/applications/RunningState;->mSequence:I

    if-ne v4, v5, :cond_26

    invoke-virtual {v15, v3}, Lcom/android/settings/applications/RunningState$ProcessItem;->ensureLabel(Landroid/content/pm/PackageManager;)V

    iget v4, v15, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I

    if-nez v4, :cond_23

    iget-object v4, v15, Lcom/android/settings/applications/RunningState$ProcessItem;->mDependentProcesses:Landroid/util/SparseArray;

    invoke-virtual {v4}, Landroid/util/SparseArray;->clear()V

    :cond_23
    iget-object v4, v15, Lcom/android/settings/applications/RunningState$ProcessItem;->mServices:Ljava/util/HashMap;
    ...
    iget v3, v5, Lcom/android/settings/applications/RunningState$ServiceItem;->mCurSeq:I
    ...
    :cond_28
    iget v3, v15, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I
    ...
    iput-boolean v12, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mIsStarted:Z

    const-wide v14, 0x7fffffffffffffffL

    iput-wide v14, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mActiveSince:J

    iget-object v14, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mServices:Ljava/util/HashMap;
    ...
    iget-object v14, v15, Lcom/android/settings/applications/RunningState$ServiceItem;->mServiceInfo:Landroid/content/pm/ServiceInfo;
    ...
    :cond_2d
    iget-object v12, v15, Lcom/android/settings/applications/RunningState$ServiceItem;->mRunningService:Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    iget-wide v14, v5, Lcom/android/settings/applications/RunningState$ProcessItem;->mActiveSince:J

    move-object/from16 v23, v4

    iget-object v4, v12, Lcom/android/settings/applications/RunningState$ServiceItem;->mRunningService:Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    invoke-virtual {v6, v4, v12}, Lcom/android/settings/applications/RunningState$ProcessItem;->addDependentProcesses(Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-virtual {v4, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget v12, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I
    ...
    iput-boolean v14, v8, Lcom/android/settings/applications/RunningState$ServiceItem;->mNeedDivider:Z
    ...
    iget-object v9, v8, Lcom/android/settings/applications/RunningState$ServiceItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;
    ...
    :cond_34
    iget-object v3, v8, Lcom/android/settings/applications/RunningState$ServiceItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;
    ...
    iget-object v8, v3, Lcom/android/settings/applications/RunningState$MergedItem;->mServices:Ljava/util/ArrayList;
    ...
    iget v9, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mUserId:I
    ...
    iget-object v15, v3, Lcom/android/settings/applications/RunningState$MergedItem;->mServices:Ljava/util/ArrayList;

    invoke-virtual {v15, v9}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iput-object v3, v9, Lcom/android/settings/applications/RunningState$ServiceItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;

    goto :goto_1e

    :cond_39
    iput-object v6, v3, Lcom/android/settings/applications/RunningState$MergedItem;->mProcess:Lcom/android/settings/applications/RunningState$ProcessItem;

    iget-object v8, v3, Lcom/android/settings/applications/RunningState$MergedItem;->mOtherProcesses:Ljava/util/ArrayList;
    ...
    iget-object v9, v3, Lcom/android/settings/applications/RunningState$MergedItem;->mOtherProcesses:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v2, v8}, Lcom/android/settings/applications/RunningState$MergedItem;->update(Landroid/content/Context;Z)Z

    iget v8, v3, Lcom/android/settings/applications/RunningState$MergedItem;->mUserId:I
    ...
    invoke-direct {v1, v2, v5, v8, v3}, Lcom/android/settings/applications/RunningState;->addOtherUserItem(Landroid/content/Context;Ljava/util/ArrayList;Landroid/util/SparseArray;Lcom/android/settings/applications/RunningState$MergedItem;)V
    ...
    iget-object v6, v1, Lcom/android/settings/applications/RunningState;->mInterestingProcesses:Ljava/util/ArrayList;
    ...
    iget v8, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mUserId:I
    ...
    invoke-virtual {v7, v2, v8}, Lcom/android/settings/applications/RunningState$MergedItem;->update(Landroid/content/Context;Z)Z

    iget-object v7, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;

    iget v7, v7, Lcom/android/settings/applications/RunningState$MergedItem;->mUserId:I

    iget v8, v1, Lcom/android/settings/applications/RunningState;->mMyUserId:I

    if-eq v7, v8, :cond_3e

    iget-object v7, v1, Lcom/android/settings/applications/RunningState;->mOtherUserMergedItems:Landroid/util/SparseArray;

    iget-object v8, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;

    invoke-direct {v1, v2, v5, v7, v8}, Lcom/android/settings/applications/RunningState;->addOtherUserItem(Landroid/content/Context;Ljava/util/ArrayList;Landroid/util/SparseArray;Lcom/android/settings/applications/RunningState$MergedItem;)V
    ...
    iget v8, v7, Lcom/android/settings/applications/RunningState$MergedItem;->mCurSeq:I
    ...
    iget-object v4, v1, Lcom/android/settings/applications/RunningState;->mProcessItems:Ljava/util/ArrayList;
    ...
    iget v14, v12, Lcom/android/settings/applications/RunningState$ProcessItem;->mCurSeq:I
    ...
    :cond_44
    iget-object v9, v12, Lcom/android/settings/applications/RunningState$ProcessItem;->mRunningProcessInfo:Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    const-string v9, "Unknown non-service process: "

    invoke-virtual {v0, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v9, v12, Lcom/android/settings/applications/RunningState$ProcessItem;->mProcessName:Ljava/lang/String;
    ...
    iget v9, v12, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I
    ...
    :try_start_2
    iget-object v3, v1, Lcom/android/settings/applications/RunningState;->mAllProcessItems:Ljava/util/ArrayList;
    ...
    iget v3, v3, Lcom/android/settings/applications/RunningState$ProcessItem;->mPid:I
    ...
    invoke-interface {v3, v0}, Landroid/app/IActivityManager;->getProcessPss([I)[J
    ...
    invoke-virtual {v6, v2, v10, v11, v0}, Lcom/android/settings/applications/RunningState$ProcessItem;->updateSize(Landroid/content/Context;JI)Z

    move-result v0

    or-int v31, v31, v0

    iget v0, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mCurSeq:I

    iget v10, v1, Lcom/android/settings/applications/RunningState;->mSequence:I

    if-ne v0, v10, :cond_49

    iget-wide v10, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mSize:J
    ...
    :cond_49
    iget-object v0, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mRunningProcessInfo:Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    iget v10, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mUserId:I

    invoke-direct {v0, v10}, Lcom/android/settings/applications/RunningState$MergedItem;-><init>(I)V

    iput-object v0, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;

    iget-object v10, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;

    iput-object v6, v10, Lcom/android/settings/applications/RunningState$MergedItem;->mProcess:Lcom/android/settings/applications/RunningState$ProcessItem;
    ...
    iget v3, v1, Lcom/android/settings/applications/RunningState;->mMyUserId:I
    ...
    iget v3, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mUserId:I

    invoke-direct {v0, v3}, Lcom/android/settings/applications/RunningState$MergedItem;-><init>(I)V

    iput-object v0, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;

    iget-object v3, v6, Lcom/android/settings/applications/RunningState$ProcessItem;->mMergedItem:Lcom/android/settings/applications/RunningState$MergedItem;
    ...
    :try_start_7
    invoke-virtual {v0, v2, v3}, Lcom/android/settings/applications/RunningState$MergedItem;->update(Landroid/content/Context;Z)Z
    ...
    iget-object v3, v1, Lcom/android/settings/applications/RunningState;->mBackgroundItems:Ljava/util/ArrayList;
    ...
    iget v12, v11, Lcom/android/settings/applications/RunningState$MergedItem;->mUserId:I
    ...
    iget v15, v14, Lcom/android/settings/applications/RunningState$MergedItem;->mUserId:I

    move/from16 v18, v0

    iget v0, v1, Lcom/android/settings/applications/RunningState;->mMyUserId:I

    if-eq v15, v0, :cond_59

    iget-object v0, v1, Lcom/android/settings/applications/RunningState;->mOtherUserBackgroundItems:Landroid/util/SparseArray;

    invoke-direct {v1, v2, v12, v0, v14}, Lcom/android/settings/applications/RunningState;->addOtherUserItem(Landroid/content/Context;Ljava/util/ArrayList;Landroid/util/SparseArray;Lcom/android/settings/applications/RunningState$MergedItem;)V
    ...
    iget-object v14, v1, Lcom/android/settings/applications/RunningState;->mOtherUserBackgroundItems:Landroid/util/SparseArray;
    ...
    iget v15, v14, Lcom/android/settings/applications/RunningState$MergedItem;->mCurSeq:I
    ...
    invoke-virtual {v14, v2, v15}, Lcom/android/settings/applications/RunningState$MergedItem;->update(Landroid/content/Context;Z)Z

    invoke-virtual {v14, v2}, Lcom/android/settings/applications/RunningState$MergedItem;->updateSize(Landroid/content/Context;)Z
    ...
    :try_start_8
    iput v4, v1, Lcom/android/settings/applications/RunningState;->mNumBackgroundProcesses:I

    iput v8, v1, Lcom/android/settings/applications/RunningState;->mNumForegroundProcesses:I

    iput v5, v1, Lcom/android/settings/applications/RunningState;->mNumServiceProcesses:I

    iput-wide v6, v1, Lcom/android/settings/applications/RunningState;->mBackgroundProcessMemory:J

    iput-wide v9, v1, Lcom/android/settings/applications/RunningState;->mForegroundProcessMemory:J
    :try_end_8
    ...
    :try_start_9
    iput-wide v2, v1, Lcom/android/settings/applications/RunningState;->mServiceProcessMemory:J

    if-eqz v13, :cond_5f

    iput-object v13, v1, Lcom/android/settings/applications/RunningState;->mBackgroundItems:Ljava/util/ArrayList;

    iput-object v12, v1, Lcom/android/settings/applications/RunningState;->mUserBackgroundItems:Ljava/util/ArrayList;
    ...
    iput-boolean v15, v1, Lcom/android/settings/applications/RunningState;->mHaveData:Z
