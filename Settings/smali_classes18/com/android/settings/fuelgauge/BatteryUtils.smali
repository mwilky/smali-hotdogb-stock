...
.method public static getInstance(Landroid/content/Context;)Lcom/android/settings/fuelgauge/BatteryUtils;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/fuelgauge/BatteryUtils;-><init>(Landroid/content/Context;)V
...
.method private getProcessBackgroundTimeMs(Landroid/os/BatteryStats$Uid;I)J
    ...
    iget-object v5, p0, Lcom/android/settings/fuelgauge/BatteryUtils;->mPackageManager:Landroid/content/pm/PackageManager;
...
.method private getScreenUsageTimeMs(Landroid/os/BatteryStats$Uid;IJ)J
    ...
    const-string v2, "foreground time(us): "
...
.method public getBatteryInfo(Lcom/android/internal/os/BatteryStatsHelper;Ljava/lang/String;)Lcom/android/settings/fuelgauge/BatteryInfo;
    ...
    new-instance v15, Lcom/android/settingslib/fuelgauge/Estimate;

    invoke-virtual {v14, v5, v6}, Landroid/os/BatteryStats;->computeBatteryTimeRemaining(J)J
    ...
    :goto_0
    const-string v7, "BatteryInfoLoader post query"

    invoke-static {v1, v7, v2, v3}, Lcom/android/settings/fuelgauge/BatteryUtils;->logRuntime(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    const-string v8, "BatteryInfoLoader.loadInBackground"

    invoke-static {v1, v8, v2, v3}, Lcom/android/settings/fuelgauge/BatteryUtils;->logRuntime(Ljava/lang/String;Ljava/lang/String;J)V
...
.method getEnhancedEstimate()Lcom/android/settingslib/fuelgauge/Estimate;
    ...
    invoke-static {v1}, Lcom/android/settingslib/fuelgauge/Estimate;->getLastCacheUpdateTime(Landroid/content/Context;)Ljava/time/Instant;
    ...
    invoke-static {v1}, Lcom/android/settingslib/fuelgauge/Estimate;->getCachedEstimateIfAvailable(Landroid/content/Context;)Lcom/android/settingslib/fuelgauge/Estimate;
    ...
    invoke-interface {v1, v2}, Lcom/android/settings/fuelgauge/PowerUsageFeatureProvider;->getEnhancedBatteryPrediction(Landroid/content/Context;)Lcom/android/settingslib/fuelgauge/Estimate;
    ...
    invoke-static {v1, v0}, Lcom/android/settingslib/fuelgauge/Estimate;->storeCachedEstimate(Landroid/content/Context;Lcom/android/settingslib/fuelgauge/Estimate;)V
...
.method public synthetic lambda$setForceAppStandby$0$BatteryUtils(IILjava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3}, Lcom/android/settings/fuelgauge/batterytip/BatteryDatabaseManager;->deleteAction(IILjava/lang/String;)Z
...
.method public setForceAppStandby(ILjava/lang/String;I)V
    ...
    new-instance v1, Lcom/android/settings/fuelgauge/-$$Lambda$BatteryUtils$ShxxVG-haRDdL8cjipNso8s_v8Y;

    invoke-direct {v1, p0, p3, p1, p2}, Lcom/android/settings/fuelgauge/-$$Lambda$BatteryUtils$ShxxVG-haRDdL8cjipNso8s_v8Y;-><init>(Lcom/android/settings/fuelgauge/BatteryUtils;IILjava/lang/String;)V
