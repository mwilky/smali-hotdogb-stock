...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings/widget/ChartView;->getChildAt(I)Landroid/view/View;
    ...
    iget-object v8, v0, Lcom/android/settings/widget/ChartView;->mContent:Landroid/graphics/Rect;

    invoke-virtual {v3, v8}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    instance-of v8, v6, Lcom/android/settings/widget/ChartGridView;

    if-eqz v8, :cond_0

    iget v8, v7, Landroid/widget/FrameLayout$LayoutParams;->gravity:I

    invoke-static {v8, v1, v2, v3, v4}, Landroid/view/Gravity;->apply(IIILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    :cond_0
    instance-of v8, v6, Lcom/android/settings/widget/ChartSweepView;

    if-eqz v8, :cond_1

    move-object v8, v6

    check-cast v8, Lcom/android/settings/widget/ChartSweepView;

    invoke-virtual {p0, v8, v3, v4}, Lcom/android/settings/widget/ChartView;->layoutSweep(Lcom/android/settings/widget/ChartSweepView;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
