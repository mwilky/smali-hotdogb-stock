...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v0, p0, Lcom/android/settings/print/ProfileSettingsPreferenceFragment$1;->val$profileSpinnerAdapter:Lcom/android/settings/dashboard/profileselector/UserAdapter;

    invoke-virtual {v0, p3}, Lcom/android/settings/dashboard/profileselector/UserAdapter;->getUserHandle(I)Landroid/os/UserHandle;
    ...
    iget-object v2, p0, Lcom/android/settings/print/ProfileSettingsPreferenceFragment$1;->this$0:Lcom/android/settings/print/ProfileSettingsPreferenceFragment;

    invoke-virtual {v2}, Lcom/android/settings/print/ProfileSettingsPreferenceFragment;->getIntentActionString()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/android/settings/print/ProfileSettingsPreferenceFragment;->getActivity()Landroidx/fragment/app/FragmentActivity;

    move-result-object v2

    invoke-virtual {v2, v1, v0}, Landroidx/fragment/app/FragmentActivity;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V

    iget-object v2, p0, Lcom/android/settings/print/ProfileSettingsPreferenceFragment$1;->val$spinner:Landroid/widget/Spinner;
