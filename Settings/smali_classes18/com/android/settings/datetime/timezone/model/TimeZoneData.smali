...
.method public constructor <init>(Llibcore/timezone/CountryZonesFinder;)V
    ...
    iget-object v0, p0, Lcom/android/settings/datetime/timezone/model/TimeZoneData;->mCountryZonesFinder:Llibcore/timezone/CountryZonesFinder;

    invoke-virtual {v0}, Llibcore/timezone/CountryZonesFinder;->lookupAllCountryIsoCodes()Ljava/util/List;
...
.method public static declared-synchronized getInstance()Lcom/android/settings/datetime/timezone/model/TimeZoneData;
    ...
    invoke-virtual {v3}, Llibcore/timezone/TimeZoneFinder;->getCountryZonesFinder()Llibcore/timezone/CountryZonesFinder;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/android/settings/datetime/timezone/model/TimeZoneData;-><init>(Llibcore/timezone/CountryZonesFinder;)V
...
.method public lookupCountryCodesForZoneId(Ljava/lang/String;)Ljava/util/Set;
    ...
    check-cast v3, Llibcore/timezone/CountryTimeZones;

    new-instance v4, Lcom/android/settings/datetime/timezone/model/FilteredCountryTimeZones;

    invoke-direct {v4, v3}, Lcom/android/settings/datetime/timezone/model/FilteredCountryTimeZones;-><init>(Llibcore/timezone/CountryTimeZones;)V
...
.method public lookupCountryTimeZones(Ljava/lang/String;)Lcom/android/settings/datetime/timezone/model/FilteredCountryTimeZones;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/settings/datetime/timezone/model/TimeZoneData;->mCountryZonesFinder:Llibcore/timezone/CountryZonesFinder;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/datetime/timezone/model/FilteredCountryTimeZones;-><init>(Llibcore/timezone/CountryTimeZones;)V
