...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/settings/localepicker/LocalePicker;->constructAdapter(Landroid/content/Context;II)Landroid/widget/ArrayAdapter;
.end annotation
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v0, p0, Lcom/android/settings/localepicker/LocalePicker$1;->val$inflater:Landroid/view/LayoutInflater;
    ...
    iget v1, p0, Lcom/android/settings/localepicker/LocalePicker$1;->val$fieldId:I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lcom/android/settings/localepicker/LocalePicker$1;->getItem(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/android/settings/localepicker/LocalePicker$LocaleInfo;

    invoke-virtual {v2}, Lcom/android/settings/localepicker/LocalePicker$LocaleInfo;->toString()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    invoke-virtual {v2}, Lcom/android/settings/localepicker/LocalePicker$LocaleInfo;->getLocale()Ljava/util/Locale;
